...
public class Usuario {
    ...
    # mappedBy indica que la relación está mapeada por el campo "usuario" en la entidad Miembro
    # CascadeType.ALL propaga todas las operaciones (persist, remove, etc.) a los miembros asociados
    ...
    public Usuario(String nombre, String email, String password) {
        ...
        this.isPremium = false; # Por defecto, los usuarios no son premium
    }
